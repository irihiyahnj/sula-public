...
- Use [docs/ops/document-design-principles.md](docs/ops/document-design-principles.md) when producing formal planning, proposal, report, process, or training documents.
