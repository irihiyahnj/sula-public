...
- ready: yes
- start here: `docs/change-records/2026-05-05-implement-sula-0-17-0-agent-native-control-surface.md`; `STATUS.md`
- latest record: `docs/change-records/2026-05-05-implement-sula-0-17-0-agent-native-control-surface.md`
- next action: review `docs/change-records/2026-05-02-commit-0-15-0-and-fix-self-referencing-validation.md`; run `python3 scripts/sula.py check --project-root .`; run `python3 -m unittest discover -s tests -v`
- next owner: Sula Core maintainers
- next due: 2026-05-08
- done when: result `SULA CHECK OK`; result `doctor strict passed`
- blockers: none
- source of truth: `STATUS.md`; `docs/change-records/2026-05-05-implement-sula-0-17-0-agent-native-control-surface.md`
