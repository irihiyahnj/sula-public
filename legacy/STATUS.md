...
> **Legacy — do not act on this file.** This is a Sula 0.18.x generated
> snapshot, kept for historical reference. The authoritative protocol is
> [AGENTS.md](AGENTS.md) and the authoritative project state is
