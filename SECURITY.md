...
If you believe you found a security issue in Sula Vector, do not open a public issue with exploit details.
...
- reproduction steps
- expected impact
- whether the issue affects only Sula Vector core or also adopted repositories
...
- path handling, file overwrite, or command execution bugs in `tools/sula_vector/` (renderer, note, migrate, hooks, or skills)
