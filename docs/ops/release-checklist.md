...
- [ ] `python3 -m py_compile scripts/sula.py tests/test_sula.py` if relevant
- [ ] `python3 -m unittest discover -s tests -v` for substantial code changes
