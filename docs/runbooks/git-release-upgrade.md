...
```bash
git -C /opt/sula/v0.13.0 fetch --tags origin
git -C /opt/sula/v0.13.0 checkout v0.13.0
git -C /opt/sula/v0.13.0 reset --hard v0.13.0
export SULA_ROOT=/opt/sula/v0.13.0
```
...
- Do not point one project at `main` and another at `v0.13.0` unless you intentionally want mixed rollout state.
