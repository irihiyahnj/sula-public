...
- status: green
- reason: Sula 0.14.0 release-grade verification now passes, the public `v0.14.0` tag exists, and the handoff contract plus Git-release upgrade path are stable for downstream rollout.
...
- validate the first real project upgrade that starts from `https://github.com/irihiyahnj/sula-public.git` at `v0.14.0`
...
- date: 2026-04-29
- trigger: review again before broad 0.14.0 rollout, changing the public bootstrap contract, or raising the handoff contract bar again
...
- next action: review `docs/releases/2026-04-22-release-sula-0-14-0-handoff-contract-and-git-release-upgrade-flow.md`; run `python3 scripts/sula.py canary verify --project-root . --all`
