...
- [Add Automation Kernel For Event Driven Orchestration](../docs/change-records/2026-05-01-zzzzz-add-automation-kernel-for-event-driven-orchestration.md)
- [Add Remote Verification And Codex Runners](../docs/change-records/2026-05-01-zzzz-add-remote-verification-and-codex-runners.md)

## Release History

- [Release Sula 0.17.0 agent-native control surface](../docs/releases/2026-05-05-release-sula-0-17-0-agent-native-control-surface.md)
- [Release Sula 0.15.0 orchestration control plane and runner boundaries](../docs/releases/2026-05-01-release-sula-0-15-0-orchestration-control-plane-and-runner-boundaries.md)
- [Release Sula 0.14.0 handoff contract and Git release upgrade flow](../docs/releases/2026-04-22-release-sula-0-14-0-handoff-contract-and-git-release-upgrade-flow.md)
