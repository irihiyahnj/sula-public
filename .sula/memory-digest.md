...
- [Add Fleet Token And Cost Status Metrics](../docs/change-records/2026-05-07-add-fleet-token-and-cost-status-metrics.md)
- [Add Deterministic Fleet Upgrade Executor](../docs/change-records/2026-05-07-add-deterministic-fleet-upgrade-executor.md)
- [Add Autopilot Intent Router And Fleet Executor Guard](../docs/change-records/2026-05-07-add-autopilot-intent-router-and-fleet-executor-guard.md)
...
- [2026-05-06 - Fix Sula Check Automation Self Lock](../docs/change-records/2026-05-06-fix-sula-check-automation-self-lock.md)

## Release History

- [Release Sula 0.18.14 Deterministic Fleet Upgrades](../docs/releases/2026-05-07-release-sula-0-18-14-deterministic-fleet-upgrades.md)
- [Release Sula 0.18.13 Fleet Token Cost Status](../docs/releases/2026-05-07-release-sula-0-18-13-fleet-token-cost-status.md)
- [Release Sula 0.18.12 Autopilot Fleet Executor Guard](../docs/releases/2026-05-07-release-sula-0-18-12-autopilot-fleet-executor-guard.md)
