...
DEFAULT_SOURCE_REPO = "https://github.com/irihiyahnj/sula.git"
DEFAULT_SOURCE_REF = "codex/bootstrap-sula"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--source-repo", default=DEFAULT_SOURCE_REPO, help="Canonical Sula source repository URL")
    parser.add_argument("--source-ref", default=DEFAULT_SOURCE_REF, help="Branch or ref to use when cloning Sula")
